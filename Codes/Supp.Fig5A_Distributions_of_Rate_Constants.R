...
hist(data1$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL28_k_ab.pdf"), width=3.5, height=3.5)
hist(data2$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL19_k_ab.pdf"), width=3.5, height=3.5)
hist(data3$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL5_k_ab.pdf"), width=3.5, height=3.5)
hist(data4$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM88_k_ab.pdf"), width=3.5, height=3.5)
hist(data5$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM793_k_ab.pdf"), width=3.5, height=3.5)
hist(data6$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM164_k_ab.pdf"), width=3.5, height=3.5)
hist(data7$k_ab, breaks=seq(-15, -2, by=0.05), main="k_ab", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

# k_ba
pdf(paste0(output, "/", "A375_k_ba.pdf"), width=3.5, height=3.5)
hist(data1$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL28_k_ba.pdf"), width=3.5, height=3.5)
hist(data2$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL19_k_ba.pdf"), width=3.5, height=3.5)
hist(data3$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL5_k_ba.pdf"), width=3.5, height=3.5)
hist(data4$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM88_k_ba.pdf"), width=3.5, height=3.5)
hist(data5$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM793_k_ba.pdf"), width=3.5, height=3.5)
hist(data6$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

pdf(paste0(output, "/", "WM164_k_ba.pdf"), width=3.5, height=3.5)
hist(data7$k_ba, breaks=seq(-15, -2, by=0.05), main="k_ba", freq = F, ylim=c(0,1.5), xlab="", xlim=c(-10,-2))
dev.off()

# k_cb
pdf(paste0(output, "/", "A375_k_cb.pdf"), width=3.5, height=3.5)
hist(data1$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL28_k_cb.pdf"), width=3.5, height=3.5)
hist(data2$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL19_k_cb.pdf"), width=3.5, height=3.5)
hist(data3$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL5_k_cb.pdf"), width=3.5, height=3.5)
hist(data4$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "WM88_k_cb.pdf"), width=3.5, height=3.5)
hist(data5$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "WM793_k_cb.pdf"), width=3.5, height=3.5)
hist(data6$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

pdf(paste0(output, "/", "WM164_k_cb.pdf"), width=3.5, height=3.5)
hist(data7$k_cb, breaks=seq(-15, -2, by=0.05), main="k_cb", freq = F, ylim=c(0,5), xlab="", xlim=c(-5,-2))
dev.off()

# k_bc
pdf(paste0(output, "/", "A375_k_bc.pdf"), width=3.5, height=3.5)
hist(data1$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL28_k_bc.pdf"), width=3.5, height=3.5)
hist(data2$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL19_k_bc.pdf"), width=3.5, height=3.5)
hist(data3$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "SKMEL5_k_bc.pdf"), width=3.5, height=3.5)
hist(data4$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "WM88_k_bc.pdf"), width=3.5, height=3.5)
hist(data5$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "WM793_k_bc.pdf"), width=3.5, height=3.5)
hist(data6$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()

pdf(paste0(output, "/", "WM164_k_bc.pdf"), width=3.5, height=3.5)
hist(data7$k_bc, breaks=seq(-19, -2, by=0.05), main="k_bc", freq = F, ylim=c(0,2), xlab="", xlim=c(-15,-2))
dev.off()
