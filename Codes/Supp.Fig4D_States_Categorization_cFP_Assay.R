...
abline(v=m, col="red", lwd=2, lty=2)
text(-0.05, 80, paste0("A0 = ", a1))
text(-0.05, 70, paste0("B0 = ", b1))
text(-0.05, 60, paste0("C0 = ", c1))
dev.off()
...
#cell4 <- data.frame(cell = "SC07", A0=a, B0=b, C0=c)
...
#cell5 <- data.frame(cell = "SC10", A0=a, B0=b, C0=c)
...
#cell6 <- data.frame(cell = "SKMEL5", A0=a, B0=b, C0=c)
...
text((m+0.009), 60, expression(m), cex=1.2)
text(0, 80, "B", cex=1.2)
text(-0.03, 80, "A", cex=1.2)
text(0.02, 80, "C", cex=1.2)
dev.off()
# ===========================================================================================================
