...
par(ps = x, cex = 1, cex.axis = 1)
hist(data1$k_cb,  freq = F, breaks=seq(-25, 2, by=0.25), col = "brown", xlim=c(-16, 0), ylim = c(0,1), main = "k_es")
hist(log(c$k_cb), freq = F, breaks=seq(-25, 0, by=0.25), col = rgb(0,0,1,0.4),  add=T)
dev.off()
