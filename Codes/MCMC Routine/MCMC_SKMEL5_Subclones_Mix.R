...
# ===========================================================================================================
pars <- c(Fit$par[c(1,2,3,4)], "A0"=1/3, "B0"=1/3)
...
iter = 150000 # Number of iterations to run for each MCMC
...
# Run MCMC algorithms
# ===========================================================================================================
print(system.time(MCMC1 <- modMCMC(f = Objective, p = c(pars), niter = iter, lower=0, 
...
# ===========================================================================================================
# Save mcmc iterations as .RData file
# ===========================================================================================================
output = getwd()
save(MCMC1, file=paste0(output, "/MCMC_", cell, "_", iter,"_Run.RData"))
