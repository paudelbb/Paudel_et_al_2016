...
# ===========================================================================================================
# ===========================================================================================================
pdf(paste0(output,"/","Empty_legend_prior_vs_posterior.pdf"), width=4, height=4)
par(ps = 12, cex = 1, cex.axis = 1)
plot(0,type='n',axes=FALSE,ann=FALSE)
legend(0.55,1, c("Prior","Posterior"), col = c(rgb(0,0,1,0.4), "brown"),horiz=T, lty=c(1,1),
       pch=c(16), lwd=5.5, bg = "gray90", bty="n")
dev.off()
